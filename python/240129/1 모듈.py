...
miles = converter.kilpmeter_to_miles(150) # 모듈.함수() 형식으로 호출
...
# 예) from 모듈 import 함수
# 예) from 모듈 import 함수1, 2
# 예) from 모듈 import * (*:모든것)

from converter import kilpmeter_to_miles # 모듈은 가져오지 않고 특정 함수만 가져옴

miles = kilpmeter_to_miles(150)
...
miles = cvt.kilpmeter_to_miles(150) # 별명을 이용해서 함수 사용
print(f'150km = {miles}miles')

print()

from converter import kilpmeter_to_miles as k_to_m # 함수에도 별명을 지정 가능
